          ...
          <div className="grid grid-cols-2 gap-[50px]  mt-[50px] mb-[50px]">
            <div>
              ...
              <p className="mb-4 text-justify">
                BIGLAW-AI, our AI-powered solution, is designed to make
                corporate lawyers' work easier by automating contract
                generation, revision, translation, and confidentiality
                maintenance. But we know there's always room for improvement and
                innovation.
              </p>
              ...
              <h3 className="text-lg mb-2">
                2. Is our system providing the accuracy and efficiency you need
                for contract review and analysis?
              </h3>
              <h3 className="text-lg mb-2">
                3. Are the multilingual translation capabilities meeting your
                needs when dealing with international clients or legal systems?
              </h3>
              ...
              <p className="mb-5">
                Address: Building 14, Beijing Institute of Technology
                (Zhongguancun campus), Haidian District, Beijing, China
              </p>
            </div>
            <div>
              <h1 className="text-2xl font-bold mb-4 text-center">
              ...
              <h3 className="mb-5 text-justify">
                ...
                provide us with your valuable feedback. Tell us how we can
                enhance BIGLAW-AI, what features you find beneficial, and any
                elements that you think could be improved. Your feedback is
                essential to us in our mission to provide an end-to-end solution
                for corporate lawyers. Help us fine-tune our service to better
                meet your needs.
              </h3>
