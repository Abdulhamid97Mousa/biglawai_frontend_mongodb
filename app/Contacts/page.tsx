        ...
        <div className="grid grid-cols-2 gap-[50px]  mt-[50px] mb-[50px]">
          ...
          <div>
            ...
            <h3 className="mb-5 text-justify">
              ...
              BIGLAW-AI, what features you find beneficial, and any elements
              that you think could be improved. Your feedback is essential to us
              in our mission to provide an end-to-end solution for corporate
              lawyers. Help us fine-tune our service to better meet your needs.
            </h3>
