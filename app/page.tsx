    ...
    <div className="min-h-screen bg-white">
      <main className="px-8 md:px-24 py-12">
        ...
        <section className="grid grid-cols-2 gap-10 mb-[100px] mt-[100px]   justify-between ">
          <div className="flex ">
            <Image
              src="/Images/Empower_Your_Legal_Team.png"
          ...
          <div className="">
            ...
            <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
              Business moves quickly. You need more time to focus on what you do
              best: modern legal design and high-level, strategic thinking.
              <br />
              <br />
              Let us help you — deliver value to the business through seamless
              and secure self-service, automate repetitive tasks, and translate
              legal contracts to handle international clients with ease.
            </h2>
          </div>
        </section>
        ...
        <section className="grid grid-cols-2 gap-10 mb-[150px] mt-[100px]   justify-between">
          <div>
            ...
            <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
              ...
              <br />
              <br />
              It can create customizable templates, which can be easily modified
              to fit the unique circumstances of each case, saving time and
              increasing efficiency.
            </h2>
          </div>
          <div className="flex justify-end">
            <Image
              src="/Images/Drafting and Summarizing Agreements.png"
        ...
        <section className="grid grid-cols-2 gap-10 mb-[150px] mt-[100px]    ">
          <div className="flex justify-between ">
            <Image
              src="/Images/Data_Security_and_Privacy.jpg"
          ...
          <div>
            ...
            <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
              Recognizing the sensitive nature of legal documents, we prioritize
        ...
        <section className="grid grid-cols-2 gap-10 mb-[150px] mt-[150px]    ">
          <div>
            ...
            <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
              BIGLAW-AI can analyze existing contracts and agreements to ensure
              their accuracy, clarity, and compliance with applicable laws and
              regulations.
              <br />
              <br />
              BIGLAW-AI can be used to monitor regulatory changes and ensure
              that companies are complying with applicable laws and regulations.
              <br />
              <br />
          ...
          <div className="flex justify-end ">
            <Image
              src="/Images/analyze legal documents .jpeg"
              alt="AI and Legal Contract Management"
              width={800}
              height={600}
              className="rounded-lg "
        ...
        <section className="grid grid-cols-2 gap-10 mb-[200px] mt-[150px]  justify-between">
          <div className="flex ">
            <Image
              src="/Images/Multilingual_Translation.jpg"
              alt="AI and Legal Contract Management"
              width={800}
              height={600}
              className="rounded-lg "
        ...
        <section className="grid grid-cols-1 gap-10  mb-[100px] mt-[100px]   ">
          ...
          <blockquote className="text-3xl italic text-justify">
            ...
            platform's advanced features, such as automated contract generation
            and multilingual translation, have not only streamlined my workflow
        ...
        <section className="grid grid-cols-1 gap-10  mb-15 mt-[100px]">
          ...
          <p className="text-3xl text-justify">
            Our team of legal experts and technologists are here to help you on
            your digital transformation journey. We will help you identify your
            starting point and build a map for your success. Learn more about
            how our Transformation team can support you with complimentary
