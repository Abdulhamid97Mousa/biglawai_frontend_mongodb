          ...
          <div className="px-8 md:px-24 py-12">
            ...
            <section className="grid grid-cols-2 gap-10 mb-[100px] mt-[100px]   justify-between ">
              ...
              <div className="">
                ...
                <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
                  Business moves quickly. You need more time to focus on what
                  you do best: modern legal design and high-level, strategic
                  thinking.
                  <br />
                  <br />
                  Let us help you — deliver value to the business through
                  seamless and secure self-service, automate repetitive tasks,
                  and translate legal contracts to handle international clients
                  with ease.
                </h2>
              </div>
            </section>
            ...
            <section className="grid grid-cols-2 gap-10 mb-[150px] mt-[100px]   justify-between">
              <div>
                ...
                <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
                  ...
                  contracts and agreements based on the user's input and
            ...
            <section className="grid grid-cols-2 gap-10 mb-[150px] mt-[100px]    ">
              ...
              <div>
                ...
                <h2 className="text-2xl ml-5 mr-5 mt-5 mb-5 justify-items-end text-justify ">
                  ...
                  before any data or document is transmitted to an online
                  API.This ensures that our customers' confidential information
                  remains protected and secure throughout the entire process.
                </h2>
              </div>
            </section>
            ...
            <section className="grid grid-cols-1 gap-10  mb-[100px] mt-[100px]   ">
              ...
              <blockquote className="text-3xl italic text-justify">
                ...
                generation and multilingual translation, have not only
                streamlined my workflow but also improved my productivity."
              </blockquote>
            ...
            <section className="grid grid-cols-1 gap-10  mb-15 mt-[100px]">
              ...
              <p className="text-3xl text-justify">
                ...
                on your digital transformation journey. We will help you
                identify your starting point and build a map for your success.
                Learn more about how our Transformation team can support you
                with complimentary planning and implementation.
              </p>
