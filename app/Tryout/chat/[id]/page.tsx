    ...
    <div className="flex">
      <div className=" flex-1 bg-white ml-10  border-2  border-[#d4d4d4]  h-screen:1000 rounded-md py-10 relative">
        ...
        <button
          ...
          className={`p-1 mr-1 rounded-md text-white ${hidePii === true?"bg-blue-700":"bg-red-700"}`}
        >
         {hidePii === true? <span>Hide personal information</span> : <span>Show personal information</span>} 
        </button>
          <Features
